...
function monochromatic_theme_setup() {
	...
	add_image_size( 'single-image', 1305, 510, true ); // 300 pixels wide (and unlimited height)
...
function wpdocs_scripts_method() {
    wp_enqueue_script( 'application', get_stylesheet_directory_uri() . '/assets/js/application.js', array( 'jquery' ) );
}
