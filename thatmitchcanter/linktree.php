...
<section id="linktrees">
	<section id="mitchcraft"><div class="row">
		<img src="https://mitchcraft.me/wp-content/themes/mitchcraft/assets/images/logo.svg" alt="CMDR Mitchcraft" />
		<p>CMDR Mitchcraft<br /><small></small></p>
		<ul class="links">
			<li><a target="_blank" href="https://twitch.tv/CMDRMitchcraft"><i class="fab fa-twitch"></i>&nbsp; Twitch</a></li>
			<li><a target="_blank" href="https://youtube.com/@CMDRMitchcraft"><i class="fab fa-youtube"></i>&nbsp; YouTube</a></li>
			<li><a target="_blank" href="https://mitchcraft.me"><i class="fas fa-link"></i>&nbsp; Website</a></li>
		</ul>
	</div></section>
	<section id="mitchcanter" style="background: #111"><div class="row">
		...
		<ul class="links">
			...
			<li><a target="_blank" href="https://primalthreads.shop"><i class="fas fa-shopping-cart"></i>&nbsp; Primal Threads</a></li>
